        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo anchor('book/view/' .$book_item['idbuku'], 'View', 'Lihat Buku'); ?>| <?php echo anchor ('book/edit/' .$book_item['idbuku'], 'Edit', 'Edit Buku'); ?>| <?php echo anchor('book/delete/'.$book_item['idbuku'], 'Del', 'Hapus Buku'); ?></td>
            </tr>
            <?php endforeach; ?>
          </tbody>
        </table>
